...
class BacktestService:
    def __init__(self, repo: KlineRepository, data_dir: Path | None = None) -> None:
        self.repo = repo
        # The repository continues to read shared market data, while result
        # artifacts belong to the authenticated account when one is present.
    ...
    def _persist(self, result: BacktestResult) -> None:
        out_dir = self.data_dir / "backtest_results"
