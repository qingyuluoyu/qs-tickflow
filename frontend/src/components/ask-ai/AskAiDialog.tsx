...
export function AskAiDialog({ task, minimized }: { task: AskTask | null; minimized: boolean }) {
  ...
  return (
    <div className="fixed bottom-16 right-4 z-[70] flex h-[min(520px,72vh)] w-[min(380px,calc(100vw-2rem))] flex-col overflow-hidden rounded-2xl border border-border bg-surface shadow-2xl">
