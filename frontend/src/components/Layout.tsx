    ...
    <div className="h-screen grid grid-cols-[14rem_1fr] bg-base text-foreground overflow-hidden">
      <aside className="border-r border-border bg-surface flex flex-col h-full min-h-0 overflow-hidden">
        <div className="px-5 py-5 border-b border-border shrink-0">
          ...
          <div hidden className="mt-2.5 text-[10px] uppercase tracking-[0.22em] text-secondary">
            Quant · Terminal
          </div>
        ...
        <button
          ...
          className="hidden mx-2 mb-1 flex items-center gap-2 rounded-btn px-2.5 py-2 text-left transition-colors hover:bg-elevated/60 shrink-0 group"
          title="数据源设置"
        >
      ...
      <motion.main
        ...
        className="relative h-full overflow-auto scrollbar-gutter-stable"
      >
        <div className="pointer-events-none sticky right-0 top-0 z-30 flex justify-end px-5 pt-3">
          <div className="pointer-events-auto flex items-center gap-2 rounded-full border border-border bg-surface/90 px-2.5 py-1.5 text-xs shadow-sm backdrop-blur">
