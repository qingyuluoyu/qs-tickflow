...
const FIELD_DEFS: Record<TabKey, FieldDef[]> = {
  metrics: [
    { label: '最新收盘价', fmt: 'perShare', key: 'close' } as any,
    { label: '换手率', fmt: 'pct', key: 'turnover_rate' } as any,
    { label: '市盈率 PE', fmt: 'num', key: 'pe' } as any,
    { label: 'TTM 市盈率', fmt: 'num', key: 'pe_ttm' } as any,
    { label: '市净率 PB', fmt: 'num', key: 'pb' } as any,
    { label: '市销率 PS', fmt: 'num', key: 'ps' } as any,
    { label: 'TTM 市销率', fmt: 'num', key: 'ps_ttm' } as any,
    { label: '股息率', fmt: 'pct', key: 'dv_ratio' } as any,
    { label: 'TTM 股息率', fmt: 'pct', key: 'dv_ttm' } as any,
    { label: '总市值', fmt: 'amount', key: 'market_cap' } as any,
    { label: '流通市值', fmt: 'amount', key: 'float_market_cap' } as any,
    { label: '量比', fmt: 'num', key: 'volume_ratio' } as any,
  ],
  income: [
